...
export class WechatApi{
    ...
    cznotify(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'wechat/cznotify',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    czprepay(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'wechat/czprepay',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
