...
export class MemberApi{
    ...
    rideraccount(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/rideraccount',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    updatastatus(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/updatastatus',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
